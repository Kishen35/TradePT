...
async def analyze_trade_decision(
    ...
    try:
        ...
        market_service = get_analysis_service()
        deriv_service = get_deriv_service()

        recent_trades = await deriv_service.get_recent_trades(limit=10)
        patterns = market_service.detect_patterns(recent_trades)
